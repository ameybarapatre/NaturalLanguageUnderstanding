...
for i in range(n_epochs):
    ...
    con_dict = conlleval(predword_train, groundtruth_train, words_train, 'r2.txt')
    ...
    con_dict = conlleval(predword_val, groundtruth_val, words_val, 'r2.txt')
    ...
    if con_dict['f1'] > best_val_f1:
    	...
    	open('RNN.json','w').write(model.to_json())
    	model.save_weights('RNN.h5',overwrite=True)
